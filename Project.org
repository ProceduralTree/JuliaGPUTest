...
#+RESULTS:
#+begin_results
[[file:./.ob-julia-snail/jl_y7slkfyRmb.png]]
#+end_results
...
#+begin_src julia :results drawer
using Plots
using LaTeXStrings
...
#+RESULTS:
julia-async:0a331a40-ca83-43c8-875c-2171e55ed2b4
...
#+begin_figure
[[file:./.ob-julia-snail/jl_kHgzqbqZwp.png]]
#+end_figure
